...
def categorize_cvss_score(score):
    if pd.isna(score) or score in ['unscored', 'CVSS unscored']:
...
def categorize_epss_score_percent(score):
    if pd.isna(score) or score in ['unscored', 'EPSS unscored']:
...
def main(file_path):
    ...
    #print("Rows with 'CVSS unscored':")
    #print(df[df['baseScore'] == 'CVSS unscored'])
    #print("Rows with 'EPSS unscored':")
    #print(df[df['epss'] == 'EPSS unscored'])
    ...
    #print(df[['CVE', 'CVE Status', 'baseScore', 'CVSS Score Range', 'epss', 'EPSS Score Range']].head())
    ...
    #print(df['CVE Status'].value_counts())
    #print(df['CVSS Score Range'].value_counts())
    #print(df['EPSS Score Range'].value_counts())
